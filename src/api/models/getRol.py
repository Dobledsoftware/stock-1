...
import aiohttp
import asyncio
#from ..recibos.recibo import Recibo # Importa Clase Recibo

#################################validar_token_Depends###############################################################
# Función que genera la dependencia de validación de token con roles permitidos
...
class GetRol(conexion.Conexion):  
    async def get_rol_function(self, token):   
        ...
        headers = {'Authorization': f'Bearer {token}'}  # Usa 'Authorization' como nombre del header
