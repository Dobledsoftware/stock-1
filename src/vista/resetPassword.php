...
<body>
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <!-- FORMULARIO -->
            <form id="fromResetPass" method="POST" onsubmit="return nuevoPass()">
                <br>
                <input type="password" id="pass" class="fadeIn second" name="pass" placeholder="Nueva contraseña" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="16" required><br>
                <input type="password" id="pass2" class="fadeIn second" name="pass2" placeholder="Repita nueva contraseña" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="16" required><br><br>  
    ...
    <script src="../public/js/usuarios/resetPassword.js"></script>
</body>
</html>
<?php
 }
